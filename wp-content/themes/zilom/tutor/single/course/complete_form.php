...
if ( ! $is_completed_course) {
    ...
    <div class="tutor-course-complete-form-wrap">
        ...
        <form method="post">
            ...
            <button type="submit" class="course-complete-button btn-theme-2" name="complete_course_btn" value="complete_course"><?php echo esc_html__( 'Complete Course', 'zilom' ); ?></button>
        </form>
    </div>
	<?php
}
