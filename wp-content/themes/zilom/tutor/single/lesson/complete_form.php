...
if ( ! $is_completed_lesson) {
    ...
    <div class="tutor-single-lesson-segment tutor-lesson-complete-form-wrap">
        ...
        <form method="post">
            ...
            <button type="submit" class="course-complete-button btn-theme-2 tutor-button" name="complete_lesson_btn" value="complete_lesson"><i class="tutor-icon-mark"></i><?php echo esc_html__( 'Complete Lesson', 'zilom' ); ?></button>
        </form>
    </div>
	<?php
}
