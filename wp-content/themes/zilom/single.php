 ...
 */
    ...
    $page_id = zilom_id();
    $default_sidebar_config = zilom_get_option('single_post_sidebar', 'right-sidebar'); 
    $default_left_sidebar = zilom_get_option('single_post_left_sidebar', 'default_sidebar');
    $default_right_sidebar = zilom_get_option('single_post_right_sidebar', 'default_sidebar');
