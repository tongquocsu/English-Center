<?php
   add_filter( 'elementor/icons_manager/additional_tabs', 'zilom_custom_icons_filters' , 9999999, 1 );
   function zilom_custom_icons_filters( $tabs = array() ) {
      $newicons = [
         "flaticon-open-book",
         "flaticon-university",
      ...
      $icons['gva_custom_icon'] = array(
           'name'          => 'zilom-icons-theme',
           'label'         => esc_html__( 'Icons Theme', 'zilom-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $newicons,
           'url'          => GAVIAS_ZILOM_PLUGIN_URL . 'assets/icons/flaticon.css',
           'ver'           => '1.0',
       );
   ...
   add_action( 'wp_print_footer_scripts', 'zilom_insert_icons_footer_css'  );
   function zilom_insert_icons_footer_css() {
      echo '<link rel="stylesheet" type="text/css" href="' . GAVIAS_ZILOM_PLUGIN_URL . 'assets/icons/flaticon.css">';
   }

   add_filter( 'elementor/icons_manager/additional_tabs', 'zilom_lineawesome_icon' );  
   function zilom_lineawesome_icon( $icons = array() ) {
       ...
       $icons['zilom-lineawesome-icon'] = array(
           'name'          => 'zilom-icons-lineawesome',
           'label'         => esc_html__( 'Line Awesome', 'zilom-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $lineawesome_icons,
            'url'          => GAVIAS_ZILOM_PLUGIN_URL . 'elementor/assets/libs/line-awesome/css/line-awesome.min.css',
           'ver'           => '1.0',
       );
